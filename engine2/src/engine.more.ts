...
export class TextureSwappingRenderer {
    ...
    constructor(
        ...
        this.context = new Context(this.outputCanvas.getContext('webgl2', {preserveDrawingBuffer: this.storePixels}), true);
        ...
        this.fb1 = createEmptyFramebufferObject(this.context.gl, w, h, 'float4', 'data');
        this.fb2 = createEmptyFramebufferObject(this.context.gl, w, h, 'float4', 'data');
    }
